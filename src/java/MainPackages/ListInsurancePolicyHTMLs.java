 ...
 * @author mutemi
 */
public class ListInsurancePolicyHTMLs extends HttpServlet 
{
                        ...
                        try 
                        {
                           ...
                           // System.out.println(ReturnDocumentIs);
                            ...
                            if(IsVerifyValid==true)
                            {
                                        ...
                                        //do the listing
                                        String UserDir=UPLOAD_DIR_NAME+"/"+is_policy_html_md5;//dir name
                                                ...
                                                for (int i = 0; i < size_of_dir; i++) 
                                                {
                                                    ...
                                                    if(!dir_name.equalsIgnoreCase("WEB-INF") && !dir_name.equalsIgnoreCase("META-INF"))
                                                    {
                                                                    ...
                                                                    for (int j = 0; j < size_of_files; j++) 
                                                                    {
                                                                            ...
                                                                            //link
                                                                            String sharable_link=FILE_SERVER_BASE_URL+is_policy_html_md5+"/"+dir_name+"/"+file_name;
                                        ...
                                        else
                                        {
                                            ...
                                            return_document.append("message", "No HTMLs uploaded!");
                                        }
